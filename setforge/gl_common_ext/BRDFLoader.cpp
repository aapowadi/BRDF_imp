...
int BRDFLoader::ReadBMP(BRDFTexMaterial& mat, const string albedo_map, const string metalic_map, const string roughness_map, const string ambient_occlusion_map)
{
    ...
    {
        cout << "[BRDFLoader] - ERROR: Did not find the albedo_map " << albedo_map << "." << endl;
        return -1;
    }
    ...
    if(!ret){
        cout << "[BRDFLoader] - ERROR: Did not load the albedo_map " << albedo_map << "." << endl;
        return -1;
    }
    ...
    {
        cout << "[BRDFLoader] - ERROR: Did not find the Metallic_map " << metalic_map << "." << endl;
        return -1;
    }
    ...
    if(!ret){
        cout << "[BRDFLoader] - ERROR: Did not load the metallic_map " << metalic_map << "." << endl;
        return -1;
    }
    num++;
    ...
    {
        cout << "[BRDFLoader] - ERROR: Did not find the roughness_map " << roughness_map << "." << endl;
        return -1;
    }
    ...
    if(!ret){
        cout << "[BRDFLoader] - ERROR: Did not load the roughness_map " << roughness_map << "." << endl;
        return -1;
    }
    num++;
    ...
    {
        cout << "[BRDFLoader] - ERROR: Did not find the ambient_map " << ambient_occlusion_map << "." << endl;
        return -1;
    }
    ...
    if(!ret){
        cout << "[BRDFLoader] - ERROR: Did not load the ambient_map " << ambient_occlusion_map << "." << endl;
        return -1;
    }
    num++;
